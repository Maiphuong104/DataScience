...
Frage:
- Ich frage mich, ob die Performance von der Decision Tree ALgo bei mir falsch ist, denn ich sehe die Aspekt "embarked" nicht dabei. Es liegt nicht bei den Code an, dann woran liegt dieser Fehler?